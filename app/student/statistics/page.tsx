  ...
  useEffect(() => {
    const loadAssessments = async () => {
      try {
        ...
        if (res.ok) setAssessments(json.assessments || []);
      } finally {
        setLoading(false);
      }
    };
    ...
    <main className="pb-20 pt-15 lg:pb-25 xl:pb-30">
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
        <div className="animate_top">
          <h1 className="text-3xl font-bold text-black dark:text-white xl:text-sectiontitle3">Statistiques</h1>
          <p className="mt-4 text-para2 text-waterloo dark:text-manatee">
            Visualisez vos indicateurs d'apprentissage et suivez votre progression.
          </p>
        </div>
...
// groupAssessments not needed for single-metric bars per period
