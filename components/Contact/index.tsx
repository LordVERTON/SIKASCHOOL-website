              ...
              >
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between ">
                  <div className="mb-4 md:mb-0">
                    <label className="flex min-h-11 max-w-[425px] cursor-pointer select-none items-center gap-3 py-1">
                      <input
                        id="contact-consent"
                        name="consent"
                        type="checkbox"
                      ...
                      />
                      <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-sm border-gray-300 bg-gray-100 text-blue-600 peer-checked:bg-primary peer-focus-visible:ring-3 peer-focus-visible:ring-primary peer-focus-visible:ring-offset-2 dark:border-gray-600 dark:bg-gray-700">
                        <svg
